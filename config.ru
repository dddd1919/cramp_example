require './application'
CrampExample::Application.initialize!

# Development middlewares
if CrampExample::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => CrampExample::Application.root(:public)
end
...
#
run CrampExample::Application.routes
